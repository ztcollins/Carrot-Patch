...
/**
 * This is the testing class that tests basic functionality of the methods below
 * 
 * @author Zach C
 *
 */
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    try {
      ...
      r.setY(200);
      // Set first Wolf at position(400,200)
      w1.setX(350); // Wolf is 212px away from Rabbit
      w1.setY(350);
      // Set second Wolf at position(300,200)
      w2.setX(200); // Wolf is 0px away from Rabbit
      w2.setY(200);
      if (r.isClose(w1, Rabbit.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
  ...
  public static boolean test3isCloseMethod() {
    ...
    try {
      ...
      r.setY(200);
      // Set first Wolf at position(400,200)
      w1.setX(10200); // Wolf is 10000px away from Rabbit
      w1.setY(200);
      // Set second Wolf at position(300,200)
      w2.setX(375); // Wolf is 175px away from Rabbit
      w2.setY(200);
      if (r.isClose(w1, Rabbit.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
  ...
  public static boolean testWolfEatRabbitMethod() {
    ...
    try {
      ...
      if (w.getX() != r.getX() && w.getY() != r.getY()) {
        ...
        System.out.println("GET X: " + w.getX());
        System.out.println("GET Y: " + w.getY());
